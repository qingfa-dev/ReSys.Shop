...
[Trait("Category","Unit")][Trait("Module","Ordering")][Trait("Entity","Adjustment")]
public class AdjustmentExtensionsTests
{
    [Fact] public void Create_ShouldReturnAdjustment() {
    ...
    [Fact] public void Close_WhenOpen_ShouldSucceed() {
