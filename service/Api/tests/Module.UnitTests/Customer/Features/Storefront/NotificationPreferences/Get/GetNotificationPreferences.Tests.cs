...
using Module.Customer.Features.Storefront.NotificationPreferences.Get;
...
public class GetNotificationPreferencesTests : IDisposable
{
    ...
    public async Task Handle_ShouldReturnPreferences()
    {
        ...
        profile.Notifications = Module.Customer.Domain.Notifications.NotificationPreferencesMethod.Create(
