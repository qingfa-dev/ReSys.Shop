...
public class StockItemExtensionsTests
{
    ...
    {
        var item = StockItemMethod.Create(Guid.NewGuid(), Guid.NewGuid(), countOnHand: 0).Value;
    ...
    {
        var item = StockItemMethod.Create(Guid.NewGuid(), Guid.NewGuid(), countOnHand: 42).Value;
