...
public class AssignProductOptionTypesValidatorTests
{
    ...
    public void Validate_WithValidRequest_ShouldPass()
    {
        var command = new AssignProductOptionTypes.Command(
            new AssignProductOptionTypes.Request { 
                ProductId = Guid.NewGuid(),
                Items = [new() { OptionTypeId = Guid.NewGuid(), Position = 1 }] });
    ...
    {
        var command = new AssignProductOptionTypes.Command(
            new AssignProductOptionTypes.Request { ProductId = Guid.NewGuid(), Items = null! });
    ...
    {
        var command = new AssignProductOptionTypes.Command(
            new AssignProductOptionTypes.Request { ProductId = Guid.NewGuid(), Items = [] });
