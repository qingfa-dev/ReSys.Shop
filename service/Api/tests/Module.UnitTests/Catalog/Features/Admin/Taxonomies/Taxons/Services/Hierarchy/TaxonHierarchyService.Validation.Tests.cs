...
public class TaxonHierarchyValidationTests : IDisposable
{
    ...
    public async Task ValidateDescendant_ShouldReturnSuccess_WhenValid()
    {
        ...
        var child1 = TaxonExtensions.Create(taxonomy.Id, root.Id, "C1", "C1", null, 0, "c1", null, null, null, false, null, null, false, null, null).Value;
        var child2 = TaxonExtensions.Create(taxonomy.Id, root.Id, "C2", "C2", null, 1, "c2", null, null, null, false, null, null, false, null, null).Value;
    ...
    public async Task ValidateDescendant_ShouldReturnFailure_WhenCircular()
    {
        ...
        var root = TaxonExtensions.Create(taxonomy.Id, null, "Root", "Root", null, 0, "root", null, null, null, false, null, null, false, null, null).Value;
        var child1 = TaxonExtensions.Create(taxonomy.Id, root.Id, "C1", "C1", null, 0, "c1", null, null, null, false, null, null, false, null, null).Value;
        var grandchild = TaxonExtensions.Create(taxonomy.Id, child1.Id, "G1", "G1", null, 0, "g1", null, null, null, false, null, null, false, null, null).Value;
    ...
    public async Task ValidateDescendant_ShouldReturnFailure_WhenDifferentTaxonomies()
    {
        ...
        var root1 = TaxonExtensions.Create(taxo1.Id, null, "R1", "R1", null, 0, "r1", null, null, null, false, null, null, false, null, null).Value;
        var root2 = TaxonExtensions.Create(taxo2.Id, null, "R2", "R2", null, 0, "r2", null, null, null, false, null, null, false, null, null).Value;
    ...
    public async Task ValidateHierarchy_ShouldReturnFailure_WhenOverlapping()
    {
        ...
        var taxonomy = TaxonomyExtensions.Create("Cat", "Cat", 0).Value;
        var root = TaxonExtensions.Create(taxonomy.Id, null, "Root", "Root", null, 0, "root", null, null, null, false, null, null, false, null, null).Value;
        var child = TaxonExtensions.Create(taxonomy.Id, root.Id, "C1", "C1", null, 0, "c1", null, null, null, false, null, null, false, null, null).Value;
    ...
    public async Task ValidateHierarchy_ShouldReturnFailure_WhenNoRoot()
    {
        ...
        var ct = TestContext.Current.CancellationToken;
        var taxonomy = TaxonomyExtensions.Create("Cat", "Cat", 0).Value;
        var taxonA = TaxonExtensions.Create(taxonomy.Id, null, "A", "A", null, 0, "a", null, null, null, false, null, null, false, null, null).Value;
        var taxonB = TaxonExtensions.Create(taxonomy.Id, null, "B", "B", null, 1, "b", null, null, null, false, null, null, false, null, null).Value;
