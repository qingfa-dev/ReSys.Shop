...
namespace Api.Migrations.Migrations
{
    ...
    [Migration("20260712050728_FixPaymentMethodSettingsColumnType")]
    partial class FixPaymentMethodSettingsColumnType
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Module.Payment.Domain.PaymentCaptures.PaymentCapture", b =>
                {
                    b.HasOne("Module.Ordering.Domain.Orders.Order", null)
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_payment_capture_orders_order_id");
