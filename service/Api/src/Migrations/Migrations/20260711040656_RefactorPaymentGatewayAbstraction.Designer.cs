...
namespace Api.Migrations.Migrations
{
    ...
    [Migration("20260711040656_RefactorPaymentGatewayAbstraction")]
    partial class RefactorPaymentGatewayAbstraction
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Shared.Operational.Webhooks.Domain.WebhookDelivery", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.HasIndex("Status", "NextRetryAtUtc")
                        .HasDatabaseName("ix_webhook_deliveries_status_next_retry_at_utc");

                    b.ToTable("webhook_deliveries", "webhooks");
                });

            modelBuilder.Entity("Shared.Operational.Webhooks.Domain.WebhookSubscription", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.HasIndex("Event")
                        .HasDatabaseName("ix_webhook_subscriptions_event");

                    b.HasIndex("Event", "Active")
                        .HasDatabaseName("ix_webhook_subscriptions_event_active");
            ...
            modelBuilder.Entity("Shared.Operational.Webhooks.Domain.WebhookDelivery", b =>
                {
                    b.HasOne("Shared.Operational.Webhooks.Domain.WebhookSubscription", null)
                        .WithMany()
                        .HasForeignKey("SubscriptionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_webhook_deliveries_webhook_subscription_subscription_id");
                });
