...
public static partial class LocationFeature
{
    ...
    public static class Admin
    {
        ...
        public static class Countries
        {
            ...
            {
                public const string Route = "api/admin/location/countries";
            ...
            {
                public const string Route = "api/admin/location/countries/{id:guid}";
            ...
            {
                public const string Route = "api/admin/location/countries/by-iso/{isoCode}";
        ...
        public static class States
        {
            ...
            public static class Create
            {
                public const string Route = "api/admin/location/states";
            ...
            public static class GetById
            {
                public const string Route = "api/admin/location/states/{id:guid}";
            ...
            public static class GetByIso
            {
                public const string Route = "api/admin/location/states/by-iso/{isoCode}";
