...
/// <summary>Handles paged or all retrieval of countries.</summary>
public static partial class GetCountryPagedOrAll
{

    // ============ PAGED QUERY ============
    /// <summary>Query to retrieve a paged or all countries.</summary>
    ...
    {
        /// <summary>Executes the paged countries query.</summary>
