...
namespace Module.Customer.Features.Storefront.Profiles.Get.Detail;
...
public static partial class GetProfile
{
    ...
    public sealed class Endpoint : ICarterModule
    {
        ...
        public void AddRoutes(IEndpointRouteBuilder app)
        {
            ...
            app.MapGet(ProfileFeature.Storefront.Profiles.Get.Route, async (
                ISender sender,
            ...
            .WithSummary(ProfileFeature.Storefront.Profiles.Get.Summary)
            .WithDescription(ProfileFeature.Storefront.Profiles.Get.Description)
