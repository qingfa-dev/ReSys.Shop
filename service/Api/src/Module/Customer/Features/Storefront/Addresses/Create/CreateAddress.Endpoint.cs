...
public static partial class CreateAddress
{
    public sealed class Endpoint : ICarterModule
    {
        ...
        {
            app.MapPost(ProfileFeature.Storefront.Addresses.Create.Route, async (
                ...
                .WithSummary(ProfileFeature.Storefront.Addresses.Create.Summary)
                .WithDescription(ProfileFeature.Storefront.Addresses.Create.Description)
