...
public static partial class ProfileFeature
{
    public static class Admin
    {
        public static class Profiles
        {
            ...
            {
                public const string Route = "api/admin/customer/all";
        ...
        public static class Addresses
        {
            public static class Create
            {
                public const string Route = "api/admin/customer/addresses";
            ...
            {
                public const string Route = "api/admin/customer/addresses/{id:guid}";
