...
/// <summary>OpenAPI schema documentation for PromotionUpdateParameters (PATCH).</summary>
public class PromotionUpdateParametersDoc : SchemaDoc<PromotionUpdateParameters>
{
    public override void Configure(SchemaDocBuilder<PromotionUpdateParameters> builder)
    {
