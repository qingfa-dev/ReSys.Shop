...
{
    public Task<Result> ProcessAsync(PaymentCapture payment, IPaymentGatewayActionProvider gateway, GatewayOptions options, CancellationToken ct = default)
    {
    ...
    public async Task<Result> CaptureAsync(PaymentCapture payment, IPaymentGatewayActionProvider gateway, GatewayOptions options, decimal? amount = null, CancellationToken ct = default)
    {
    ...
    public async Task<Result> RefundAsync(PaymentCapture payment, IPaymentGatewayActionProvider gateway, GatewayOptions options, decimal amount, CancellationToken ct = default)
    {
    ...
    public async Task<Result> VoidTransactionAsync(PaymentCapture payment, IPaymentGatewayActionProvider gateway, GatewayOptions options, object? source = null, CancellationToken ct = default)
    {
    ...
    public Task<Result> ConfirmAsync(PaymentCapture payment, IPaymentGatewayActionProvider gateway, CancellationToken ct = default)
    {
        StartedProcessing(payment);
    ...
    private async Task<Result> AuthorizeAsync(PaymentCapture payment, IPaymentGatewayActionProvider gateway, GatewayOptions options, CancellationToken ct = default)
    {
        var preconditions = HandlePaymentPreconditions(payment, gateway);
    ...
    private async Task<Result> PurchaseAsync(PaymentCapture payment, IPaymentGatewayActionProvider gateway, GatewayOptions options, CancellationToken ct = default)
    {
        var preconditions = HandlePaymentPreconditions(payment, gateway);
        if (preconditions.IsFailure)
            return preconditions;
    ...
    private async Task<Result> CancelAsync(PaymentCapture payment, IPaymentGatewayActionProvider gateway, CancellationToken ct = default)
    {
    ...
    private async Task<Result> CreditAsync(PaymentCapture payment, IPaymentGatewayActionProvider gateway, GatewayOptions options, decimal amount, CancellationToken ct = default)
    {
