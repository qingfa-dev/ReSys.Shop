...
public static class PaymentMethodResult
{
    ...
    public static class Errors
    {
        ...
        public static Error NameTooLong => Error.Validation(
            ...
            description: $"Payment method name cannot exceed {PaymentMethodConstant.Constraints.MaxNameLength} characters.");
        ...
        public static Error CodeTooLong => Error.Validation(
            ...
            description: $"Payment method code cannot exceed {PaymentMethodConstant.Constraints.MaxCodeLength} characters.");
        ...
        public static Error ProviderTypeRequired => Error.Validation(
            ...
            description: "Payment method provider type is required.");
        ...
        public static Error ProviderTypeTooLong => Error.Validation(
            ...
            description: $"Payment method provider type cannot exceed {PaymentMethodConstant.Constraints.MaxProviderTypeLength} characters.");
        ...
        public static Error DescriptionTooLong => Error.Validation(
            ...
            description: $"Payment method description cannot exceed {PaymentMethodConstant.Constraints.MaxDescriptionLength} characters.");
        ...
        public static Error CodeDuplicate => Error.Conflict(
            ...
            description: "A payment method with the same code already exists.");
