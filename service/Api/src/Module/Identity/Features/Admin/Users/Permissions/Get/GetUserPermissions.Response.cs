...
{
    /// <summary>
    /// Represents the response structure for retrieving user permissions.
    ...
    public class Response
    {
        ...
        {
            /// <summary>
            /// Gets or initializes a value indicating whether this permission is assigned to the user.
            /// </summary>
