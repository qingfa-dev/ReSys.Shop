...
public static partial class OrderingFeature
{
    ...
    public static class Admin
    {
        public static class Orders
        {
            ...
            {
                public const string Route = "api/admin/ordering/orders";
            ...
            {
                public const string Route = "api/admin/ordering/orders/{id:guid}";
            ...
            {
                public const string Route = "api/admin/ordering/orders/{id:guid}/status";
            ...
            {
                public const string Route = "api/admin/ordering/orders/{id:guid}/shipment-state";
            ...
            {
                public const string Route = "api/admin/ordering/orders/{id:guid}/line-items";
            ...
            {
                public const string Route = "api/admin/ordering/orders/{id:guid}/line-items/{lineItemId:guid}";
            ...
            {
                public const string Route = "api/admin/ordering/orders/{id:guid}/cancel";
            ...
            {
                public const string Route = "api/admin/ordering/orders/{id:guid}/complete";
            ...
            {
                public const string Route = "api/admin/ordering/orders/{id:guid}/approve";
            ...
            {
                public const string Route = "api/admin/ordering/orders/{id:guid}/resume";
            ...
            {
                public const string Route = "api/admin/ordering/orders/{id:guid}/ship-address";
            ...
            {
                public const string Route = "api/admin/ordering/orders/{id:guid}/bill-address";
            ...
            {
                public const string Route = "api/admin/ordering/orders/{id:guid}/shipping-method";
