...
public static partial class OrderingFeature
{
    ...
    public static class Storefront
    {
        public static class Cart
        {
            ...
            {
                public const string Route = "api/storefront/ordering/cart";
            ...
            {
                public const string Route = "api/storefront/ordering/cart/associate";
            ...
            {
                public const string Route = "api/storefront/ordering/cart/items";
            ...
            {
                public const string Route = "api/storefront/ordering/cart/items/{lineItemId:guid}";
            ...
            {
                public const string Route = "api/storefront/ordering/cart/empty";
            ...
            {
                public const string Route = "api/storefront/ordering/cart/checkout";
            ...
            {
                public const string Route = "api/storefront/ordering/cart/validate";
            ...
            {
                public const string Route = "api/storefront/ordering/cart/shipping-rate";
        ...
        public static class Orders
        {
            ...
            {
                public const string Route = "api/storefront/ordering/orders/{id:guid}";
            ...
            {
                public const string Route = "api/storefront/ordering/orders/{id:guid}/cancel";
            ...
            {
                public const string Route = "api/storefront/ordering/orders";
            ...
            {
                public const string Route = "api/storefront/ordering/orders/{id:guid}/tracking";
