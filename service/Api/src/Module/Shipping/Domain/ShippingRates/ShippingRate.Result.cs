...
public static class ShippingRateResult
{
    ...
    public static class Errors
    {
        ...
        public static Error NotFound(Guid id) => Error.NotFound(
            ...
            message: $"ShippingRate with ID '{id}' was not found.");
        ...
        public static Error AlreadySelected => Error.Conflict(
            ...
            message: "Shipping rate is already selected.");
        ...
        public static Error NotSelected => Error.Conflict(
            ...
            message: "Shipping rate is not currently selected.");
        ...
        public static Error CostRequired => Error.Validation(
            ...
            message: "Shipping rate cost must be greater than zero.");
        ...
        public static Error NameTooLong => Error.Validation(
            ...
            message: $"Shipping rate name cannot exceed {ShippingRateConstant.Constraints.MaxNameLength} characters.");
