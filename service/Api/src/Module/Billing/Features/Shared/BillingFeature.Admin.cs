...
public sealed partial class BillingFeature
{
    public static class Admin
    {
        public static class Payments
        {
            ...
            {
                public const string Route = "api/admin/billing/payments";
                ...
                public static PermissionMetadata Permission => BillingFeatureMetadata.Payments.List;
            }

            public static class GetById
            {
                public const string Route = "api/admin/billing/payments/{id:guid}";
            ...
            {
                public const string Route = "api/admin/billing/payments/{id:guid}/capture";
                public const string Description = "Capture an authorized payment";
                public const string Summary = "Capture payment";
                public static PermissionMetadata Permission => BillingFeatureMetadata.Payments.Capture;
            }

            public static class Void
            {
                public const string Route = "api/admin/billing/payments/{id:guid}/void";
                public const string Description = "Void an authorized payment";
                public const string Summary = "Void payment";
                public static PermissionMetadata Permission => BillingFeatureMetadata.Payments.Void;
            }

            public static class Refund
            {
                public const string Route = "api/admin/billing/payments/{id:guid}/refund";
                public const string Description = "Refund a captured payment";
                public const string Summary = "Refund payment";
                public static PermissionMetadata Permission => BillingFeatureMetadata.Payments.Refund;
            }
        }
        ...
        public static class PaymentMethods
        {
            public static class GetAll
            {
                public const string Route = "api/admin/billing/payment-methods";
                ...
                public static PermissionMetadata Permission => BillingFeatureMetadata.PaymentMethods.Read;
            }

            public static class GetById
            {
                public const string Route = "api/admin/billing/payment-methods/{id:guid}";
            ...
            public static class Create
            {
                ...
                public static PermissionMetadata Permission => BillingFeatureMetadata.PaymentMethods.Create;
            }
            ...
            public static class Update
            {
                ...
                public static PermissionMetadata Permission => BillingFeatureMetadata.PaymentMethods.Update;
            }
            ...
            public static class Delete
            {
                ...
                public static PermissionMetadata Permission => BillingFeatureMetadata.PaymentMethods.Delete;
            }

            public static class Activate
            {
                public const string Route = "api/admin/billing/payment-methods/{id:guid}/activate";
                public const string Description = "Activate a payment method";
                public const string Summary = "Activate payment method";
                public static PermissionMetadata Permission => BillingFeatureMetadata.PaymentMethods.Activate;
            }

            public static class Deactivate
            {
                public const string Route = "api/admin/billing/payment-methods/{id:guid}/deactivate";
                public const string Description = "Deactivate a payment method";
                public const string Summary = "Deactivate payment method";
                public static PermissionMetadata Permission => BillingFeatureMetadata.PaymentMethods.Deactivate;
            }
        }
    }
}
