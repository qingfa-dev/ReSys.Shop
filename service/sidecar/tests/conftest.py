...
def find_artifacts_dir():
    """
    Locate the local models directory within the sidecar service.
    """
    # sidecar/tests/conftest.py -> sidecar/
    sidecar_root = Path(__file__).resolve().parent.parent
    local_models = sidecar_root / "models"
...
os.environ.setdefault("API_KEY", "test-key-for-sidecar-integration-tests")
...
# ── Shared constants ──────────────────────────────────────────────────────────
VALID_API_KEY = "test-key-for-sidecar-integration-tests"
