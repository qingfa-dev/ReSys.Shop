...
- *Models.* The benchmarking harness supports 11 architectures: CNN (ResNet-50, ResNet-101, ResNet-152, EfficientNet-B0, EfficientNet-B4), ViT (DINOv2 ViT-S/14, DINOv2 ViT-B/14), CLIP (ViT-B/32, ViT-B/16, ViT-L/14, Fashion-CLIP). Each has a thin adapter implementing `generate_embeddings`. Of these, six representative models are evaluated in Chapter 3: Fashion-CLIP, DINOv2 ViT-S/14, CLIP ViT-B/16, CLIP ViT-B/32, ResNet-50, and EfficientNet-B0.
