...
*Goal:* Create and update country and state reference data. *Trigger:* the administrator opens country or state management. *Related requirements:* LOC-FR-01, LOC-FR-02, LOC-FR-03, LOC-FR-04. The flow creates and edits ISO-coded country and state records with active-status flags; alternatives warn about deactivating or deleting records referenced elsewhere (states, shipping zones, addresses), and an exception handles duplicate ISO codes.
