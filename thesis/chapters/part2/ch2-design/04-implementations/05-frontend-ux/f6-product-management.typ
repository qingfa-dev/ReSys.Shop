...
#figure(
  ...
  caption: [Admin product listing: paginated table with thumbnail, Product Name (linked), SKU, Category breadcrumb, Status badge (coloured pill), Price (VND), Last Modified. Toolbar: search, category dropdown, status filter, "New Product" button.],
...
#figure(
  ...
  caption: [Product creation form: Basic Info (name, auto-generated slug, description, status), Fashion Metadata (style code, season, material, department, gender), SEO section. Option Type assignment via source/target PickList dual-transfer. "Save" and "Save and Publish" buttons.],
...
#figure(
  ...
  caption: [Variant management: table with Master radio, SKU, Barcode, Options, Inventory toggle, Price, Dimensions, Edit/Delete actions. "Add Variant" button.],
) <fig-admin-variants>

#figure(
  image("../../../../../figures/chapters/part2/ch2-design/04-implementations/screenshots/admin-variant-pricing.png", width: 100%),
  caption: [Variant pricing tab: price history with entries (Current, Sale, Scheduled). "Add Price" inline form with amount, currency, date range.],
...
#figure(
  ...
  caption: [Images tab: sortable grid of image cards, each with drag handle, alt text, embedding status badge (green checkmark + "Fashion-CLIP"), delete icon. Upload zone with drag-drop. "Regenerate All Embeddings" button.],
) <fig-admin-images>
