...
check "raw Tailwind palette" rg -n 'class="[^"]*(green-|red-|gray-|white-|black-|slate-|zinc-|neutral-|stone-|blue-|yellow-|sky-|indigo-|violet-|purple-|pink-|rose-|orange-|lime-|cyan-|fuchsia-|amber-|emerald-|teal-)[0-9]' "$STORE" --glob '*.vue'
