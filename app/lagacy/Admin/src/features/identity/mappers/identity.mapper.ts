...
import type { AuthSessionResponse } from '../types/identity.response.type'
import type { AuthSession } from '../../auth/types/auth.model.type'

export function mapAuthSession(login: LoginResponse, session: AuthSessionResponse | null): AuthSession {
  return {
