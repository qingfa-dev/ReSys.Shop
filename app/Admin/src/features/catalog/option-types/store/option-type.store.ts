...
import type { OptionTypeListItem, OptionTypeDetail } from '../types/option-type.response'
import type { CreateOptionTypeRequest, UpdateOptionTypeRequest } from '../types/option-type.request'
