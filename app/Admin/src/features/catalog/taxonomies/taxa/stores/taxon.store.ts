...
export const useTaxonStore = defineStore('taxon', () => {
  ...
  async function fetchTaxons(taxonomyId: string, query?: TaxonQuery) {
    ...
    if (result.success && result.data) {
      ...
      error.value = result.error.detail || 'Failed to fetch taxons';
  ...
  async function addTaxon(taxonomyId: string, request: Omit<CreateTaxonRequest, 'taxonomy_id'>) {
    ...
    if (result.success) {
        ...
        error.value = result.error.detail || 'Failed to add taxon';
  ...
  async function updateTaxon(taxonomyId: string, taxonId: string, request: UpdateTaxonRequest) {
    ...
    if (result.success) {
        ...
        error.value = result.error.detail || 'Failed to update taxon';
  ...
  async function deleteTaxon(taxonomyId: string, taxonId: string) {
    ...
    if (result.success) {
        ...
        error.value = result.error.detail || 'Failed to delete taxon';
  ...
  async function fetchRules(taxonomyId: string, taxonId: string) {
    ...
    if (result.success && result.data) {
      ...
      currentRules.value = result.data;

    } else if (!result.success) {

      error.value = result.error.detail || 'Failed to fetch rules';
  ...
  async function addRule(taxonomyId: string, taxonId: string, request: CreateTaxonRuleRequest) {
    ...
    if (result.success) {
        ...
        error.value = result.error.detail || 'Failed to add rule';
  ...
  async function updateRule(taxonomyId: string, taxonId: string, ruleId: string, request: UpdateTaxonRuleRequest) {
    ...
    if (result.success) {
        ...
        error.value = result.error.detail || 'Failed to update rule';
  ...
  async function deleteRule(taxonomyId: string, taxonId: string, ruleId: string) {
    ...
    if (result.success) {
        ...
        error.value = result.error.detail || 'Failed to delete rule';
  ...
  async function regenerateProducts(taxonomyId: string, taxonId: string) {
    ...
    if (!result.success) {
        ...
        error.value = result.error.detail || 'Failed to regenerate products';
