...
vi.mock('@/common/api/http/api.client', () => ({
  default: {
    get: vi.fn<any>().mockResolvedValue({ data: {} }),
    post: vi.fn<any>().mockResolvedValue({ data: {} }),
    put: vi.fn<any>().mockResolvedValue({ data: {} }),
    patch: vi.fn<any>().mockResolvedValue({ data: {} }),
    delete: vi.fn<any>().mockResolvedValue({ data: {} }),
  }
}))
