...
import type { VariantDetail, VariantSummary } from '../products/types/variant.domain.types'
import type { CreateVariantRequest, UpdateVariantRequest } from '../products/types/variant.request.types'
