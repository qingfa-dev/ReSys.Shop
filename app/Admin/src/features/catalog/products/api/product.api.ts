...
export const productRepository = {
  ...
  ): Promise<ServerPagedResult<ProductSummaryModel>> => {
  ...
  ): Promise<ServerResult<ProductDetailModel>> => {
  ...
  uploadImage: async (
    ...
    _role?: number,
    _alt?: string,
  ): Promise<ServerResult<ProductImage>> => ({
    isSuccess: true,
    statusCode: 200,
    errors: [],
    message: null,
