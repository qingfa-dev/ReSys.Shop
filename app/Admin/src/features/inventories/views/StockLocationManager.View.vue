  ...
  <div class="flex flex-col h-full">
    ...
    <div class="flex flex-1 gap-6 p-6 pt-0 overflow-hidden min-h-[600px]">
                ...
                <template #content>
                    <div class="flex flex-col h-full">
                        ...
                        <div class="flex-1 overflow-y-auto p-2 scrollbar-thin">
                            <div v-if="loading && locationTree.length === 0" class="flex flex-col items-center justify-center py-20">
        ...
        <div class="flex-1 overflow-hidden flex flex-col">
            ...
            <div v-else-if="route.name === 'inventory.locations.manager' || !route.params.id && route.name !== 'inventory.locations.create'" class="flex-1 flex flex-col items-center justify-center bg-surface-50/50 dark:bg-surface-950/20 rounded-3xl border-2 border-dashed border-surface-200 dark:border-surface-800">
