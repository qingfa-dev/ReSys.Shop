...
describe('orderingRepository', () => {
  ...
  it('addLineItem calls correct route', async () => {
    await orderingRepository.orders.addLineItem('ord-1', { variantId: 'v-1', quantity: 2 })
  ...
  it('updateLineItem calls correct route', async () => {
    await orderingRepository.orders.updateLineItem('ord-1', 'li-1', { quantity: 3 })
  ...
  it('removeLineItem calls correct route', async () => {
    await orderingRepository.orders.removeLineItem('ord-1', 'li-1')
  ...
  it('cancel calls correct route', async () => {
    await orderingRepository.orders.cancel('ord-1', 'out of stock')
  ...
  it('complete calls correct route', async () => {
    await orderingRepository.orders.complete('ord-1')
  ...
  it('approve calls correct route', async () => {
    await orderingRepository.orders.approve('ord-1')
  ...
  it('resume calls correct route', async () => {
    await orderingRepository.orders.resume('ord-1')
  ...
  it('updateStatus calls correct route', async () => {
    await orderingRepository.orders.updateStatus('ord-1', 'Processing')
  ...
  it('updateShipAddress calls correct route', async () => {
    await orderingRepository.orders.updateShipAddress('ord-1', { city: 'NYC' })
  ...
  it('updateBillAddress calls correct route', async () => {
    await orderingRepository.orders.updateBillAddress('ord-1', { city: 'LA' })
  ...
  it('updateShippingMethod calls correct route', async () => {
    await orderingRepository.orders.updateShippingMethod('ord-1', 'sm-1')
  ...
  it('fulfillments.getQueue calls correct route', async () => {
    await orderingRepository.fulfillments.getQueue({ page: 1 })
