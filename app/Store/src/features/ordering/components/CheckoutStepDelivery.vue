...
<template>
  ...
  <div class="bg-white rounded-xl border border-gray-200 p-6">
    ...
    <!-- Section: No Methods -->
    <p v-else-if="methods.length === 0" class="text-sm text-gray-500 mb-6">No shipping methods available.</p>
    ...
    <div v-else class="mb-6 space-y-2">
      <div
        ...
        :class="selectedMethodId === method.id ? 'border-teal-600 bg-teal-50' : 'border-gray-200 hover:border-gray-300'"
      ...
      >
        ...
        <label :for="`ship-${method.id}`" class="flex-1 text-sm cursor-pointer">
          ...
          <span v-if="method.adminName || method.code" class="block text-gray-500">
