...
const product: StoreProductDetailResponse = {
  ...
  masterVariant: {
    ...
    stock: { totalOnHand: 12, totalReserved: 0, totalAvailable: 12, backorderable: false, locations: [] },
  },
  variants: [
    {
      id: "mv-1",
    ...
    },
    {
      ...
      prices: [
        { id: "pr-2", amount: 48, currency: "USD", compareAtAmount: null, countryIso: "US" },
      ],
      stock: { totalOnHand: 8, totalReserved: 0, totalAvailable: 8, backorderable: false, locations: [] },
    },
  ],
  classifications: [
    {
...
describe("ProductDetailView", { timeout: 30_000 }, () => {
  ...
  it("switches tabs and reveals the details content", async () => {
    ...
    const detailsTab = wrapper
      .findAll('[data-pc-name="tab"]')
      .find((t) => t.text().trim() === "Details");
