...
<template>
  <div class="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
      ...
      <template #content>
        <div class="flex flex-col items-center gap-4 py-6 text-center">
          <FileUpload
            ...
            @select="onSelect"
          />
          <p class="text-sm text-surface-500 dark:text-surface-400">JPEG, PNG, WebP — max 10 MB</p>
        </div>
      </template>
    </Card>
    ...
    <div v-if="vs.state === 'results'">
      <h2 class="mb-6 text-sm font-medium uppercase tracking-wide text-surface-500 dark:text-surface-400">
