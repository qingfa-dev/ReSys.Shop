...
import { useProductStore } from '@/features/catalog/products';
import { useFormatter } from '@/common/composables/formatter.use';
import { useI18n } from 'vue-i18n';
import { useToast } from '@/common/composables/toast.use';
import { variantRepository } from '@/features/catalog/variants';
...
import type { ProductSummaryModel } from '@/features/catalog/products';
import type { VariantSummary } from '@/features/catalog/variants';
...
const onProductSelect = async (product: ProductSummaryModel) => {
    productsLoading.value = true;
    try {
        const varRes = await variantRepository.listByProductId(product.id);
