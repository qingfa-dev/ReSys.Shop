...
export function descriptionSchema(_t: (key: string, args?: Record<string, unknown>) => string) {
...
export function metaTitleSchema(_t: (key: string, args?: Record<string, unknown>) => string) {
  return z.string().max(100).optional().nullable()
}

export function metaDescriptionSchema(_t: (key: string, args?: Record<string, unknown>) => string) {
  return z.string().max(255).optional().nullable()
}

export function metaKeywordsSchema(_t: (key: string, args?: Record<string, unknown>) => string) {
  return z.string().max(255).optional().nullable()
}
