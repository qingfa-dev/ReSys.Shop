...
import { createRoleSchema } from '../types/role.field'
import PageShell from '@/shared/components/navigation/PageShell.vue'
import PageHeader from '@/shared/components/navigation/PageHeader.vue'
import FormField from '@/shared/components/form/FormField.vue'
import { roleRepository } from '../api/role.api'
import type { CreateRoleRequest, UpdateRoleRequest } from '../types/role.request'
...
async function loadRole() {
  const res = await roleRepository.getById(roleId.value)
...
const onSubmit = handleSubmit(async (values) => {
  ...
  try {
    if (isEditMode.value) {
      ...
      const res = await roleRepository.update(roleId.value, updateData)
      if (res.isSuccess) {
      ...
      const res = await roleRepository.create(createData)
      if (res.isSuccess) {
