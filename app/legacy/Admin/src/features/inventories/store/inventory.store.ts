...
import type { StockTransfer } from '../stock-transfers/types/stock-transfer.response';
import type { StockItemQuery } from '../stock-items/types/stock-item.query';
import type { InventoryUnitQuery } from '../inventory-units/types/inventory-unit.query';
