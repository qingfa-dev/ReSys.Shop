...
24. Should the RTM include test case IDs (e.g., TC-001) linked to requirement IDs (e.g., CAT-FR-01 → TC-CAT-001)?
25. Is the estimated coverage table acceptable, or should actual `coverlet` numbers be populated?
