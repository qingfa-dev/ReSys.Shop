@echo off
REM System Architecture Diagram Generator (Mermaid)
echo ========================================
echo Mermaid System Architecture Generator
echo ========================================

set MMDC_PATH=mmdc
set SOURCE_DIR=%~dp0sources
set OUTPUT_DIR=%~dp0..\..\images\diagrams\02-system-architecture
...
echo Generating System Architecture diagrams at HIGH RESOLUTION...
