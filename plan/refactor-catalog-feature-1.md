...
- **REQ-003**: Flatten URL routes: remove nested path segments (e.g. `api/catalog/option-types/option-values` -> `api/catalog/option-values`; `api/catalog/products/variants/{id}` -> `api/catalog/variants/{id}`) exactly as listed in the Route Mapping table in section 2 (Reference).
...
- **CON-004**: `CatalogFeature.Admin.Route = "api/catalog"` and `CatalogFeature.Storefront.Route = "api/storefront"` remain unchanged.
...
- **PAT-001**: Flattened class shape — `public static partial class CatalogFeature { public static class Admin { public const string Route = "api/catalog"; public static class <Entity> { private const string BaseRoute = $"{Route}/<entity>"; public static class <Action> { public const string Route = BaseRoute; /* or $"{BaseRoute}/{{id:guid}}" */ public const string Description = "..."; public const string Summary = "..."; public static PermissionMetadata Permission => CatalogFeatureMetadata.<Group>.<Action>; } } } }`.
...
|------|------|------|------|
| `Admin.OptionTypes.*` | unchanged | `api/catalog/option-types...` | unchanged |
| `Admin.OptionTypes.OptionValues.Create/GetAll/GetById/Update/Delete.Route` | `Admin.OptionValues.Create/GetAll/GetById/Update/Delete.Route` | `api/catalog/option-types/option-values[/{id:guid}]` | `api/catalog/option-values[/{id:guid}]` |
| `Admin.Taxonomies.*` | unchanged | `api/catalog/taxonomies...` | unchanged |
| `Admin.Taxonomies.Taxons.Create/GetAll/GetById/Update/Delete.Route` | `Admin.Taxons.Create/GetAll/GetById/Update/Delete.Route` | `api/catalog/taxonomies/taxons[/{id:guid}]` | `api/catalog/taxons[/{id:guid}]` |
| `Admin.Taxonomies.Taxons.GetTree.Route` | `Admin.Taxons.GetTree.Route` | `api/catalog/taxonomies/taxons/tree` | `api/catalog/taxons/tree` |
| `Admin.Taxonomies.Taxons.GetList.Route` | `Admin.Taxons.GetList.Route` | `api/catalog/taxonomies/taxons/list` | `api/catalog/taxons/list` |
| `Admin.Taxonomies.Taxons.Restore.Route` | `Admin.Taxons.Restore.Route` | `api/catalog/taxonomies/taxons/{id:guid}/restore` | `api/catalog/taxons/{id:guid}/restore` |
| `Admin.Taxonomies.Taxons.Reposition.Route` | `Admin.Taxons.Reposition.Route` | `api/catalog/taxonomies/taxons/{id:guid}/reposition` | `api/catalog/taxons/{id:guid}/reposition` |
| `Admin.Taxonomies.Taxons.Rules.Create.Route` | `Admin.TaxonRules.Create.Route` | `api/catalog/taxonomies/taxons/{id:guid}/rules` | `api/catalog/taxon-rules` (body `TaxonId`) |
| `Admin.Taxonomies.Taxons.Rules.GetAll.Route` | `Admin.TaxonRules.GetAll.Route` | `api/catalog/taxonomies/taxons/{id:guid}/rules` | `api/catalog/taxon-rules` (`?taxonId=`) |
| `Admin.Taxonomies.Taxons.Rules.Update.Route` | `Admin.TaxonRules.Update.Route` | `api/catalog/taxonomies/taxons/{id:guid}/rules/{ruleId:guid}` | `api/catalog/taxon-rules/{ruleId:guid}` (body `TaxonId`) |
| `Admin.Taxonomies.Taxons.Rules.Delete.Route` | `Admin.TaxonRules.Delete.Route` | `api/catalog/taxonomies/taxons/{id:guid}/rules/{ruleId:guid}` | `api/catalog/taxon-rules/{ruleId:guid}` (body `TaxonId`) |
| `Admin.Taxonomies.Taxons.Rules.Sync.Route` | `Admin.TaxonRules.Sync.Route` | `api/catalog/taxonomies/taxons/{id:guid}/rules/sync` | `api/catalog/taxon-rules/sync` (body `TaxonId`) |
| `Admin.Products.*` | unchanged | `api/catalog/products...` | unchanged |
| `Admin.Products.OptionTypes.Get.Route` | `Admin.ProductOptionTypes.Get.Route` | `api/catalog/products/{id:guid}/option-types` | `api/catalog/product-option-types` (`?productId=`) |
| `Admin.Products.OptionTypes.Assign/Revoke/Sync.Route` | `Admin.ProductOptionTypes.Assign/Revoke/Sync.Route` | `api/catalog/products/{id:guid}/option-types/{verb}` | `api/catalog/product-option-types/{verb}` (body `ProductId`) |
| `Admin.Products.Classifications.Get.Route` | `Admin.ProductClassifications.Get.Route` | `api/catalog/products/{id:guid}/classifications` | `api/catalog/product-classifications` (`?productId=`) |
| `Admin.Products.Classifications.Assign/Revoke/Sync.Route` | `Admin.ProductClassifications.Assign/Revoke/Sync.Route` | `api/catalog/products/{id:guid}/classifications/{verb}` | `api/catalog/product-classifications/{verb}` (body `ProductId`) |
| `Admin.Products.Variants.Add.Route` | `Admin.Variants.Add.Route` | `api/catalog/products/variants` | `api/catalog/variants` |
| `Admin.Products.Variants.GetAll.Route` | `Admin.Variants.GetAll.Route` | `api/catalog/products/variants` | `api/catalog/variants` |
| `Admin.Products.Variants.GetById/Update/Delete.Route` | `Admin.Variants.GetById/Update/Delete.Route` | `api/catalog/products/variants/{id:guid}` | `api/catalog/variants/{id:guid}` |
| `Admin.Products.Variants.Prices.Set.Route` | `Admin.VariantPrices.Set.Route` | `api/catalog/products/variants/{variantId:guid}/prices` | `api/catalog/variant-prices` (body `VariantId`) |
| `Admin.Products.Variants.Prices.List.Route` | `Admin.VariantPrices.List.Route` | `api/catalog/products/variants/{variantId:guid}/prices` | `api/catalog/variant-prices` (`?variantId=`) |
| `Admin.Products.Variants.Prices.Remove.Route` | `Admin.VariantPrices.Remove.Route` | `api/catalog/products/variants/{variantId:guid}/prices/{priceId:guid}` | `api/catalog/variant-prices/{priceId:guid}` (body `VariantId`) |
| `Admin.Products.Variants.Prices.Sync.Route` | `Admin.VariantPrices.Sync.Route` | `api/catalog/products/variants/{variantId:guid}/prices/sync` | `api/catalog/variant-prices/sync` (body `VariantId`) |
| `Admin.Products.Variants.OptionValues.Get.Route` | `Admin.VariantOptionValues.Get.Route` | `api/catalog/products/variants/{variantId:guid}/option-values` | `api/catalog/variant-option-values` (`?variantId=`) |
| `Admin.Products.Variants.OptionValues.Assign/Revoke/Sync.Route` | `Admin.VariantOptionValues.Assign/Revoke/Sync.Route` | `api/catalog/products/variants/{variantId:guid}/option-values/{verb}` | `api/catalog/variant-option-values/{verb}` (body `VariantId`) |
| `Admin.Products.Variants.Images.Upload.Route` | `Admin.VariantImages.Upload.Route` | `api/catalog/products/variants/{variantId:guid}/images` | `api/catalog/variant-images` (form `VariantId`) |
| `Admin.Products.Variants.Images.GetAll.Route` | `Admin.VariantImages.GetAll.Route` | `api/catalog/products/variants/{variantId:guid}/images` | `api/catalog/variant-images` (`?variantId=`) |
| `Admin.Products.Variants.Images.GetById/Update/Delete.Route` | `Admin.VariantImages.GetById/Update/Delete.Route` | `api/catalog/products/variants/images/{id:guid}` | `api/catalog/variant-images/{id:guid}` |
| `Admin.Products.Variants.Images.Download.Route` | `Admin.VariantImages.Download.Route` | `api/catalog/products/variants/images/{id:guid}/download` | `api/catalog/variant-images/{id:guid}/download` |
| `Admin.Products.Variants.Images.Embeddings.Create.Route` | `Admin.VariantImageEmbeddings.Create.Route` | `api/catalog/products/variants/images/{id:guid}/embeddings` | `api/catalog/variant-image-embeddings` (body `VariantImageId`) |
| `Admin.Products.Variants.Images.Embeddings.Regenerate.Route` | `Admin.VariantImageEmbeddings.Regenerate.Route` | `api/catalog/products/variants/images/{id:guid}/embeddings` | `api/catalog/variant-image-embeddings/regenerate` (body `VariantImageId`) |
...
| Task | Description | Completed | Date |
|------|-------------|-----------|------|
| TASK-027 | Update the 5 OptionValues integration tests under `service/Api/tests/Api.Tests/Scenarios/Catalog/Admin/OptionTypes/OptionValues/`: replace the URL prefix `api/catalog/option-types/option-values` with `api/catalog/option-values` in every request. | |  |
| TASK-028 | Update the 9 Taxon integration tests under `service/Api/tests/Api.Tests/Scenarios/Catalog/Admin/Taxonomies/Taxons/`: replace the URL prefix `api/catalog/taxonomies/taxons` with `api/catalog/taxons` (keep the `/{id}`/`/tree`/`/list`/`/restore`/`/reposition` suffixes). | |  |
| TASK-029 | Update the 3 ProductOptionTypes integration tests under `service/Api/tests/Api.Tests/Scenarios/Catalog/Admin/Products/OptionTypes/`: `Assign`, `Revoke`, `Get`. Replace `api/catalog/products/{id}/option-types/...` with `api/catalog/product-option-types/...`; for the GET move the product id to the `productId` query param; for Assign/Revoke add `"productId": <id>` to the JSON body. | |  |
| TASK-030 | Update the 3 ProductClassifications integration tests under `service/Api/tests/Api.Tests/Scenarios/Catalog/Admin/Products/Classifications/`: `Assign`, `Revoke`, `Get`. Replace `api/catalog/products/{id}/classifications/...` with `api/catalog/product-classifications/...`; GET uses `productId` query param; Assign/Revoke add `"productId": <id>` to the JSON body. | |  |
| TASK-031 | Update the 3 VariantPrices integration tests under `service/Api/tests/Api.Tests/Scenarios/Catalog/Admin/Products/Variants/Prices/` (`Set/SetPrice.IntegrationTests.cs`, `List/ListPrices.IntegrationTests.cs`, `Remove/RemovePrice.IntegrationTests.cs`): replace `api/catalog/variants/{id}/prices` with `api/catalog/variant-prices`; the GET uses `variantId` query param; Set/Sync add `"variantId": <id>` to the JSON body; Remove uses `api/catalog/variant-prices/{priceId}` with `"variantId": <id>` in the body. | |  |
| TASK-032 | Update the 3 VariantOptionValues integration tests under `service/Api/tests/Api.Tests/Scenarios/Catalog/Admin/Products/Variants/OptionValues/` (`Get`, `Assign`, `Revoke`): replace `api/catalog/variants/{id}/option-values` with `api/catalog/variant-option-values`; GET uses `variantId` query param; Assign/Revoke add `"variantId": <id>` to the JSON body. | |  |
| TASK-033 | Update the 6 VariantImages integration tests under `service/Api/tests/Api.Tests/Scenarios/Catalog/Admin/Products/Variants/Images/` (`Upload`, `GetAll`, `GetById`, `Update`, `Delete`, `Download`): replace `api/catalog/variants/{id}/images` with `api/catalog/variant-images`; GET uses `variantId` query param; Upload adds `VariantId` as a multipart form field. | |  |
...
- **ALT-005**: Reuse the integration tests' existing partial-flatten routes (`api/catalog/variants/{id}/prices`) as the target. **Rejected** — those tests are internally inconsistent with each other and with production; the parent-id relocation rule supersedes them.
...
- **RISK-002**: Flattened routes with sub-action paths (`api/catalog/taxons/tree`, `api/catalog/variant-prices/sync`) must not collide with `{id:guid}` routes. Mitigation: all `{id}`/`{ruleId}`/`{priceId}` route params keep the `:guid` constraint, so literal segments like `tree`, `list`, `sync`, `assign` never match them.
- **RISK-003**: The existing integration tests under `Api.Tests/Scenarios/Catalog/` are already inconsistent with current production routes (e.g. they call `api/catalog/variants/{id}/prices` while production registers `api/catalog/products/variants/{id}/prices`). Phase 9 rewrites them to the new spec rather than reconciling to the old routes.
